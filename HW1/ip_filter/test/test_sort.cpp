...
BOOST_AUTO_TEST_SUITE(test_sort)
    ...
    BOOST_AUTO_TEST_CASE(sort_ips_1) {
        ...
        expected.push_back(split("1.10.1.1", '.'));
        expected.push_back(split("1.2.1.1", '.'));
        expected.push_back(split("1.1.1.1", '.'));
    ...
    BOOST_AUTO_TEST_CASE(sort_ips_2) {
        std::vector<std::vector<std::string>> ip_pool;
        ip_pool.push_back(split("1.1.1.1", '.'));
        ip_pool.push_back(split("2.1.1.1", '.'));
        ip_pool.push_back(split("10.1.1.1", '.'));

        sort_in_reverse_lexicographic_order(ip_pool);

        std::vector<std::vector<std::string>> expected;
        expected.push_back(split("10.1.1.1", '.'));
        expected.push_back(split("2.1.1.1", '.'));
        expected.push_back(split("1.1.1.1", '.'));
    ...
    BOOST_AUTO_TEST_CASE(sort_ips_3) {
        ...
        std::vector<std::vector<std::string>> expected;
        expected.push_back(split("157.39.22.224", '.'));
        expected.push_back(split("113.162.145.156", '.'));
        expected.push_back(split("79.180.73.190", '.'));
